...
/**
 * Class which constantly polls an InputStream and allows the user to see if any
 * data is available.
 * 
 * @author Tin Pavlinic
...
public class IOThread extends Thread {
	...
	/**
	 * Returns the next line of text if available. Otherwise returns null.
	 * 
	...
	/**
	 * Returns all the lines of text that are available. Otherwise returns null.
	 * 
	 * @return the next line of text or null
	 */
