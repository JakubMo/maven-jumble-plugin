...
/**
 * Tests the RTSI class. Extremely low com.reeltwo.jumble score so this needs
 * more work.
 * 
 * @author Tin Pavlinic
...
public class RTSITest extends TestCase {
	public void testRTSI() throws Exception {
		Collection c = RTSI.find("com.reeltwo.jumble.util",
				"com.reeltwo.jumble.util.Command");
	...
	public void testJarRTSI() throws Exception {
		...
		Collection c = RTSI.find("org.apache.bcel.generic",
