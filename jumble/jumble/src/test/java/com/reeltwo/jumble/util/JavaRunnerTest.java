...
public class JavaRunnerTest extends TestCase {
	...
	public void testStart() throws IOException {
		...
		mProcess = new JavaRunner("com.reeltwo.jumble.util.DisplayEnvironment")
				.start();
		...
		assertEquals("java.home " + props.getProperty("java.home"), out
				.readLine());
		assertEquals("java.class.path " + props.getProperty("java.class.path"),
				out.readLine());
	...
	public void testArguments() throws Exception {
		mProcess = new JavaRunner("com.reeltwo.jumble.util.DisplayArguments",
				new String[] { "one", "two", "three" }).start();
	...
	public void testConstructor() {
		JavaRunner jr = new JavaRunner(
				"com.reeltwo.jumble.util.DisplayEnvironment");
	...
	public void testSpaces() throws IOException {
		mProcess = new JavaRunner("com.reeltwo.jumble.util.DisplayArguments",
				new String[] { "word1 word2", "word3\tword4" }).start();
	...
	public void testAssertions() throws IOException {
		...
		String java = System.getProperty("java.home") + ls + "bin" + ls
				+ "java";

		Runtime r = Runtime.getRuntime();
		BufferedReader reader;

		Process p = r.exec(new String[] { java, "-ea", "-cp",
				System.getProperty("java.class.path"),
				"com.reeltwo.jumble.util.CheckAssertions" });
		reader = new BufferedReader(new InputStreamReader(p.getInputStream()));
		assertEquals("Assertions on", reader.readLine());
		reader.close();

		p = r.exec(new String[] { java, "-cp",
				System.getProperty("java.class.path"),
				"com.reeltwo.jumble.util.CheckAssertions" });
		reader = new BufferedReader(new InputStreamReader(p.getInputStream()));
